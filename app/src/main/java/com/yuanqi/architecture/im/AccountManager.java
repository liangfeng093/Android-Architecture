 ...
 * @author Matt Tucker
 *         <p>
 *         重写AccountManager，修改部分代码。createAccount添加返回值
 */
public final class AccountManager extends Manager {
     ...
     * @throws InterruptedException
     */
    public Registration createAccount(Localpart username, String password) throws NoResponseException, XMPPErrorException, NotConnectedException, InterruptedException {
        // Create a map for all the required attributes, but give them blank values.
        Map<String, String> attributes = new HashMap<String, String>();
        for (String attributeName : getAccountAttributes()) {
            attributes.put(attributeName, "");
        }
        return createAccount(username, password, attributes);
    }
     ...
     */
    public Registration createAccount(Localpart username, String password, Map<String, String> attributes)
